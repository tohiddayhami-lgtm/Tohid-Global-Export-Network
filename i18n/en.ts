export const en = {
  ...
  promptSubcategoryId: 'Subcategory id (slug):',
  confirmDeleteSubcategory: 'Delete subcategory "{{id}}"?',
  importOk: 'Imported.',
  ...
  subcategoryHeading: 'Subcategory: {{id}}',
  addSubcategory: 'Add subcategory',
  parentCategory: 'Parent category',
  subcategoriesHint: 'If a category has visible subcategories, visitors will choose a subcategory before seeing vendors.',
  add: 'Add',
